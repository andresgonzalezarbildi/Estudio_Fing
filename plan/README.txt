...
Configuración:
Ver CONFIGURAR_GOOGLE_DRIVE.txt. Esta versión requiere Netlify Functions y tres variables de entorno: GOOGLE_CLIENT_ID, GOOGLE_CLIENT_SECRET y SESSION_SECRET. El Client ID se obtiene únicamente desde GOOGLE_CLIENT_ID en Netlify. google-drive-config.js ya no se carga.
