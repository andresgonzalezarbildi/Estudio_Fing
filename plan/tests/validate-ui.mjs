...
assert.match(html, /driveRecoveryButton/);
...
assert.match(js, /saveRecoveryBackup/);
assert.match(js, /restoreRecoveryBackup/);
assert.match(syncFn, /Drive es la fuente de verdad/);
